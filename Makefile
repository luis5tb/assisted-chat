...
.PHONY: all \
	...
	generate run resume stop rm logs \
	query query-int query-stage query-prod query-interactive \
	query_v2 query_v2-int query_v2-stage query_v2-prod \
	streaming_query \
	streaming_query_v2 \
	delete delete_v2 mcphost test-eval psql sqlite transcript-summaries-prod help
